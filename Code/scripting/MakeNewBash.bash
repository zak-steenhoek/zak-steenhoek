...
# Updated: March 2025 
#
# Purpose: This is a script to create a new bash file in the current or specified directory with
...
# 	  
# Out: A new bash file in the specified or current location with the user entered name, a general
...
makeHeader() 
{
	...
	local FILE_TYPE="Bash Script (.bash)"
...
{	
	...
	while ! $done; do
		...
		# Else create file with general header
			...
			# Function makeHeader handles file creation
			makeHeader
			
			# Grant execution permission to the new script
			chmod +x $fileName
			
			# Display the new file in stdout
			cat $fileName
			break
		fi
	done
