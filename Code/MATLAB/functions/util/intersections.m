...
% Psuedoauthor: Zakary Steenhoek
% Created: November 2024
% Updated: February 2025
function [x0,y0,iout,jout] = intersections(x1,y1,x2,y2,robust)
%INTERSECTIONS Intersections of curves.
%   [X0,Y0,IOUT,JOUT] = INTERSECTIONS(X1,Y1,X2,Y2,ROBUST) computes the 
%   (x,y) locations where two curves intersect. The curves can be broken 
